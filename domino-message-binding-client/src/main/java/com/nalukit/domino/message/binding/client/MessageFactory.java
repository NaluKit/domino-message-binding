package com.nalukit.domino.message.binding.client;

import com.nalukit.domino.message.binding.client.presenter.IsProgressBarPresenter;
import com.nalukit.domino.message.binding.client.presenter.PresenterRegistration;
